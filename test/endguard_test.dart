        ...
        for (var j = 0; j < encryptionAlgorithms.length; j++) {
          ...
          group(
            ...
            test(
              ...
              final connectionConfirmation = await b.applyConnectionOffer(
                  welcomePackage.exportPackage(),
              ...
              final aState = StateAccessor.withState(
                  ConnectionState.fromBuffer(a.getState()));
              final bState = StateAccessor.withState(
                  ConnectionState.fromBuffer(b.getState()));
